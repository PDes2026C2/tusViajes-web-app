...
- **Package Structure:** Organize code by layer (e.g., `com.example.app.controller`, `com.example.app.service`) rather than by feature/domain (e.g., `com.example.app.order`, `com.example.app.user`) .
...
- **Secrets Management:** Do not hardcode secrets. Use environment variables.
